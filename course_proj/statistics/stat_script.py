...
def create_report(years,
    ...
    excel_doc.create_sheet(title='Статистика по годам JAVA', index=1)
    excel_doc.create_sheet(title='Статистика по городам ', index=2)
    excel_doc.create_sheet(title='Статистика по городам JAVA', index=3)
    excel_doc.create_sheet(title='Стат. ключ. скилл по год', index=4)
    excel_doc.create_sheet(title='Стат. ключ. скилл по год JAVA', index=5)
